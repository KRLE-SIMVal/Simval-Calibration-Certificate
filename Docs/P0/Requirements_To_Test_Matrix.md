...
| F-013 certificate metadata | Required metadata validation. | DOM-010, WF-030 | Planned |
...
| F-031 selected equipment on certificate | Traceability table and artifact content. | EQ-020, CERT-040 | Planned |
...
| O-003 finalized PDFs | Released artifact immutability and revision-only regeneration. | CERT-120 to CERT-129 | Planned |
| O-004 artifact history | All artifacts retrievable with checksum. | CERT-130 to CERT-139 | Planned |
